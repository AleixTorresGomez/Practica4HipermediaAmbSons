...
//no es pot fer tot amb una function si es fan servir les classes del p5.play
function baixarCoin(){
  if(coin.position.y < 600 ){
    coin.position.y += score.dificultat;
  }
    else if(coin.position.y > 599){ 
      coin.position.y = -100;
      coin.position.x = Math.floor(Math.random() * 360) + 140;
...
function baixarBirra(){
  if(birra.position.y < 600 ){
    birra.position.y += score.dificultat;
  }
    else if(birra.position.y > 599){ 
      birra.position.y = -100;
...
function baixarUnigresca(){
  if(unigresca.position.y < 600 ){
    unigresca.position.y += score.dificultat;
  }
    else if(unigresca.position.y > 599){ 
      unigresca.position.y = -100;
      unigresca.position.x = Math.floor(Math.random() * 360) + 140;
      num =  Math.floor(Math.random() * 4)+1;
    }  
...
function baixarNetflix(){
  if(netflix.position.y < 600 ){
    netflix.position.y += score.dificultat;
  }
    else if(netflix.position.y > 599){ 
      netflix.position.y = -100;
